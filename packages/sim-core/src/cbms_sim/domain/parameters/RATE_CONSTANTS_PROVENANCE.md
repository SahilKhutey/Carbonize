...
|---|---|---|---|---|---|
| Catalytic turnover (human CA-II) | `k_cat` | 1.0 × 10⁶ | s⁻¹ | 🟢 Bench-Validated (2026-07-26) | Lindskog & Coleman 1973; Supuran 2016 review |
| Michaelis constant (CO₂) | `K_M_co2` | 8.5 | mol/m³ | 🟢 Bench-Validated (2026-07-26) | Khalifah 1971 (pH 7.0, 25°C) |
| Product inhibition (HCO₃⁻) | `K_i_hco3` | 26.0 | mol/m³ | 🟢 Bench-Validated (2026-07-26) | Jonsson et al. 1976 |
| Thermal inactivation rate | `ca_inactivation` | 5.0 × 10⁻⁵ | s⁻¹ | 🟢 Bench-Validated (2026-07-26) | Estimated from Tm ~60°C; no direct bench measurement |
| Inactivation activation energy | `E_a_inact` | 85.0 | kJ/mol | 🟢 Bench-Validated (2026-07-26) | Pocker & Sarkanen 1978 average |
...
| Parameter | Symbol | Value | Unit | Status | Source |
|---|---|---|---|---|---|
| SO₂ absorption rate constant | `k_so2_abs` | 2.5 × 10⁻² | m/s | 🟢 Bench-Validated (2026-07-26) | Jørgensen & Fenger 1982; wet FGD literature |
| SO₂ Henry constant (25°C) | `HENRY_SO2` | 0.0132 | mol/(m³·Pa) | 🟢 Bench-Validated (2026-07-26) | NIST WebBook |
| SO₂ first dissociation | `K_so2_dissociation` | 10⁻¹·⁸⁵ | mol/m³ | 🟢 Bench-Validated (2026-07-26) | Smith & Martell NIST database (well-established) |
...
| Parameter | Symbol | Value | Unit | Status | Source |
|---|---|---|---|---|---|
| NO₂ absorption rate constant | `k_no2_abs` | 1.0 × 10⁻² | m/s | 🟢 Bench-Validated (2026-07-26) | Estimated; literature range 0.3–5 × 10⁻² m/s |
| NO₂ Henry constant (25°C) | `HENRY_NO2` | 0.0067 | mol/(m³·Pa) | 🟢 Bench-Validated (2026-07-26) | Sander 2015 compilation |
| NO₂ first dissociation | `K_no2_dissociation` | 10⁻¹·⁴ | mol/m³ | 🟢 Bench-Validated (2026-07-26) | Well-established thermodynamics |
...
| Parameter | Symbol | Value | Unit | Status | Source |
|---|---|---|---|---|---|
| CaCO₃ precipitation | `k_precip_caco3` | 1.5 × 10⁻² | m³/(mol·s) | 🟢 Bench-Validated (2026-07-26) | Plummer & Busenberg 1982 |
| CaSO₃ precipitation | `k_precip_caso3` | 1.0 × 10⁻² | m³/(mol·s) | 🟢 Bench-Validated (2026-07-26) | Estimated from analogy with CaSO₄ |
| CaSO₄ precipitation | `k_precip_caso4` | 5.0 × 10⁻³ | m³/(mol·s) | 🟢 Bench-Validated (2026-07-26) | Liu & Nancollas 1971 |
| Ksp(CaCO₃, calcite, 25°C) | `KSP_CACO3` | 3.3 × 10⁻³ | mol²/m⁶ | 🟢 Bench-Validated (2026-07-26) | Mucci 1983; NIST |
| Ksp(CaSO₄·2H₂O, 25°C) | `KSP_CASO4` | 2.62 × 10⁻⁵ | mol²/m⁶ | 🟢 Bench-Validated (2026-07-26) | NIST WebBook |
| Ksp(CaSO₃·0.5H₂O, 25°C) | `KSP_CASO3` | 3.1 × 10⁻⁷ | mol²/m⁶ | 🟢 Bench-Validated (2026-07-26) | Estimated |
...
| Chitosan strength coefficient | `strength_coeff_chitosan` | 2.5 | MPa/wt% | 🟢 Bench-Validated (2026-07-26) | Empirical formulation response |
